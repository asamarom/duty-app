          ...
          <CardContent className="space-y-4">
            ...
            <div className="p-4 rounded-lg border border-border bg-card/50">
              <div className="flex items-center gap-3 mb-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">For approved members</p>
                </div>
              </div>
              <Button
                type="button"
            ...
            <div className="p-4 rounded-lg border border-border bg-card/50">
              <div className="flex items-center gap-3 mb-3">
                ...
                <div>
                  <h3 className="font-medium text-foreground">Sign Up</h3>
                  <p className="text-sm text-muted-foreground">Request access to join</p>
                </div>
              </div>
              <Button
                type="button"
              ...
              <p className="text-xs text-muted-foreground mt-2 text-center">
                You'll need to complete a request form and wait for admin approval
              </p>
            </div>
          </CardContent>
        </Card>
