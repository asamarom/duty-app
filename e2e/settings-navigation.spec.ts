 ...
 *
 * Tests bottom navigation changes and general navigation behavior:
 ...
 *
 * NOTE: Role-specific Settings tabs tests are in separate files:
 * - settings-navigation-admin.spec.ts (admin role tests)
 * - settings-navigation-leader.spec.ts (leader role tests)
 * - settings-navigation-user.spec.ts (regular user role tests)
 */
